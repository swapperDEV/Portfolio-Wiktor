...
import { particlesOptions } from "../../assets/data/particles/home_side_options";
  ...
  return (
    <section className="home_wrapper" ref={ref}>
      <Background className="home">
        ...
        <p className="welcome" data-aos="fade-up">
          HELLO 👋
        </p>
        <p className="name" data-aos="fade-up">
          I am Wiktor Maciążek.
        </p>
        ...
        <div className="social_icons" data-aos="fade-up">
          ...
          <a href="https://github.com/swapperDEV/" target="blank">
